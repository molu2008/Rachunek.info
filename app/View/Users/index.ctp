<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('personal_data_id'); ?></th>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($user['PersonalData']['id'], array('controller' => 'personal_datas', 'action' => 'view', $user['PersonalData']['id'])); ?>
		</td>
		<td class="actions">
