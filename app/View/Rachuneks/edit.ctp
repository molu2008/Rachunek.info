...
<?php echo $this->Form->create('Rachunek'); ?>
	<fieldset>
		<legend><?php echo __('Edit Rachunek'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Rachunek.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Rachunek.id'))); ?></li>
